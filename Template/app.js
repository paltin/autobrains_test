(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/Autobrains.loader.js";
    var config = {
        dataUrl: buildUrl + "/Autobrains.data",
        frameworkUrl: buildUrl + "/Autobrains.framework.js",
        codeUrl: buildUrl + "/Autobrains.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Paltin",
        productName: "Autobrains",
        productVersion: "0.1",
    };
